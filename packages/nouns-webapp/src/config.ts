...
const config: Record<SupportedChains, Config> = {
  [ChainId.Rinkeby]: {
    ...
    seedContract: '0xb2200d2f5e14e3bdd4e8406d15eb4da159c75bc4'
  },
  [ChainId.Mainnet]: {
    chainName: 'mainnet',
    ...
    seedContract: '0xb2200d2f5e14e3bdd4e8406d15eb4da159c75bc4',
    auctionProxyAddress: '0x3a91EaAcd2D5d5B7E102E17ca8BD467B79139ed5',
    nounsDescriptor: '0x76e88a252d2e5ff216b2510118040fc138fc54e4',
