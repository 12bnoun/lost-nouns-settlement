...
const getNounSeedFromBlockHash = (nounId, blockHash) => {
    ...
    return {
        background: (0, exports.getPseudorandomPart)(pseudorandomness, image_data_json_1.bgcolors.length - 2, 0),
        body: (0, exports.getPseudorandomPart)(pseudorandomness, bodies.length - 2, 48),
        accessory: (0, exports.getPseudorandomPart)(pseudorandomness, accessories.length - 2, 96),
        head: (0, exports.getPseudorandomPart)(pseudorandomness, heads.length - 2, 144),
        glasses: (0, exports.getPseudorandomPart)(pseudorandomness, glasses.length - 2, 192),
    };
};
